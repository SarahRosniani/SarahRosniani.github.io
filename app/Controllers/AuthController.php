...
class AuthController extends Controller
{
    ...
    public function attemptRegister()
    {
        ...
        if ($this->config->requireActivation !== null) {
            ...
            // Success!
            return redirect()->to('http://localhost:8080/index.php/admin')->with('message', lang('Auth.activationSuccess'));
        }

        // Success!
        return redirect()->to('http://localhost:8080/index.php/admin')->with('message', lang('Auth.registerSuccess'));
    }
